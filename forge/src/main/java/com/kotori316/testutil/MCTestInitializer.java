...
public final class MCTestInitializer implements BeforeAllCallback {
    ...
    private static final class DummyModInfo implements IModInfo, IConfigurable {
        private final String name;
        private final DummyModFileInfo modFileInfo = new DummyModFileInfo(this);
    ...
    private static final class DummyModFileInfo implements IModFileInfo {
        private final DummyModInfo modInfo;

        private DummyModFileInfo(DummyModInfo modInfo) {
